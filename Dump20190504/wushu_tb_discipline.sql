...
CREATE TABLE `tb_discipline` (
  ...
  `AD_DESCRIZIONE` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `AD_ID_ASSOCIAZIONE` int(11) NOT NULL,
  PRIMARY KEY (`AD_ID`),
  UNIQUE KEY `AD_ID_UNIQUE` (`AD_ID`),
  KEY `IX_ID_ASSOCIAZIONE` (`AD_ID_ASSOCIAZIONE`),
  CONSTRAINT `FK_DISCIPLINE_ASSOCIAZIONI` FOREIGN KEY (`AD_ID_ASSOCIAZIONE`) REFERENCES `anagrafica_associazioni` (`ass_id`)
